...
export default async function handler(req, res) {
    if(req.method === "GET"){           // retrieve all records for a user     GET /api/scores/:_id
        ...
        const {language, difficulty, quantity, yourScore, totalScore, accuracy, rating} = req.body;
        const {id} = req.query;
        try{
            ...
            const newScore = {language, difficulty, quantity, yourScore, totalScore, accuracy, rating};
